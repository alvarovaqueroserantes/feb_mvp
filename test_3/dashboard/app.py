...
if analysis_focus == "Overview":
    ...
    with col1:
        ...
        insights = [
            ...
            "🛡️ **Defensive Coordination:** D4-D5 communication gap (1.2s) exploited in 3 possessions",
            "🎯 **Shooting Efficiency:** Corner 3PT% 48% vs Wing 3PT% 35%",
            "⚖️ **PlayerLoad Distribution:** Guards carry 55% of offensive load vs 45% for bigs",
